export default {
  ...
  table: {
    ...
    api: {
      ...
      createTime: 'createTime',
      updateTime: 'updateTime',
      isAuth0: 'No Authentication',
      isAuth1: 'Authentication',
      isOpen0: 'Inside',
      isOpen1: 'Open',
      tips: 'Automatically scan@EnableBrightCloudResourceServer resource server interface information.'
    },
    refresh: 'Refresh',
    operation: 'Operation',
    search: 'Search',
  ...
  tips: {
    ...
    neverLogin: 'Never logged in to the Bright system',
    nothing: 'Nothing',
    ...
    iframeGrant: 'Userame: Bright Password: 123456',
  ...
  rules: {
    ...
    blockList: 'The routeId already exists',
  ...
  common: {
    ...
    desc: {
      a: 'Based on Spring Boot 2.3.2 & Spring Cloud Hoxton.SR7 & Duddo',
