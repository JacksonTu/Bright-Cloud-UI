export default {
  ...
  table: {
    ...
    api: {
      ...
      isOpen0: '拒绝公开访问',
      isOpen1: '允许公开访问',
      tips: '自动扫描@EnableBrightCloudResourceServer资源服务器接口信息.'
    },
    refresh: '刷新',
    operation: '操作',
    search: '搜索',
  ...
  tips: {
    ...
    iframeGrant: '用户名：Bright 密码：123456',
    notEqual: '两次输入不一致',
  ...
  common: {
    system: '分布式微服务权限系统',
    desc: {
      a: '基于Spring Boot 2.3.6 & Spring Cloud Hoxton.SR9 & Dubbo',
