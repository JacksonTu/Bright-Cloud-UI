...
export default {
        ...
        requestMethod: [
          ...
          { validator: (rule, value, callback) => {
            if (!this.blockList.id && this.blockList.requestMethod && this.blockList.requestUri) {
              r.get('route/auth/blockList/exist', {
  ...
  methods: {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          if (!this.blockList.id) {
            // create
            r.post('route/auth/blockList', { ...this.blockList }).then(() => {
            ...
            // update
            r.put('route/auth/blockList', { ...this.blockList }).then(() => {
              this.buttonLoading = false
              this.isVisible = false
              this.$message({
    ...
    reset() {
      ...
      this.blockList = this.initBlackList()
    }
  }
}
</script>
